        ...
        while (true) {
            ...
            if (line.equals("EXIT")) {
                if (departments.size() == 0) {
                    System.out.println("ERROR: 1개 이상의 부서를 입력해 주세요");
                    continue;
                }
            ...
            if (departments.containsKey(departmentName) == true) {
                System.out.println("ERROR: 이미 존재하는 부서입니다.");
                continue;
            }
            try {
                int staffCount = Integer.parseInt(token[1]);
                if (staffCount > 1000) {
                    System.out.println("ERROR: 0 ~ 1000명 이하의 인원만 입력해 주세요");
                    continue;
                }
        ...
        while (true) {
            ...
            if (line.equals("EXIT")) {
                if (departmentTree.getTopDepartment() == null) {
                    System.out.println("ERROR: 최상위 부서가 입력되지 않았습니다.");
                    continue;
                }
                System.out.println("입력 완료");
                return;
            ...
            if (checkFormat(line, "^[*a-zA-Z]+ > [a-zA-Z]+$") == false) {
                System.out.println("ERROR: [* > 부서명] 또는 [부서명 > 부서명] 형식에 맞지 않습니다.");
                continue;
            }
            ...
            if (token[0].equals("*")) {
                ...
                if (childDepartment == null) {
                    System.out.println("ERROR: 존재하지 않는 부서입니다.");
                    continue;
                }
                ...
                if (parentDepartment == null) {
                    System.out.println("ERROR: " + token[0] + "는 존재하지 않는 부서입니다.");
                    continue;
                }
                if (childDepartment == null) {
                    System.out.println("ERROR: " + token[2] + "는 존재하지 않는 부서입니다.");
                    continue;
                }
